...
$MalwareConfig = @{
    ...
    Metadata = @{
        ...
        Author = "sentinelrshuser"
        ThreatFamily = "Trojan.GPFJ/Pomal"
        FirstSeen = "2025-05-06"
        Severity = "CRITICAL"
        Description = "RecipeLister/Recipe Finder trojan disguised as recipe app. Electron-based malware with revoked code signing certificate. Uses NSIS installer and drops Chromium components. Exhibits crypto behaviors and network adapter enumeration."
        CVSS = "8.5"
        ThreatIntelSource = "VirusTotal - 41/76 detections"
        FileHashes = @{
    ...
    Certificates = @{
        ...
        MaliciousThumbprints = @(
            "C9BE49E1CFD42DA1B305344C2D705397CDC5A12B"  # Global Tech Allies ltd (REVOKED)
        )
    ...
    RegistryHKLM = @(
        "SOFTWARE\WOW6432Node\RecipeLister",
        "SOFTWARE\RecipeLister",
        "SOFTWARE\Recipe Finder",
        "SOFTWARE\recipe-finder",
        "SOFTWARE\Global Tech Allies"
    )
